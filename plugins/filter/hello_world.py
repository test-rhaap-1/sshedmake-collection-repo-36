"""A hello-world filter plugin in sshedmake_namespace_36.myrhdh_36."""
...
DOCUMENTATION = """
    name: hello_world
    author: Sshedmake_namespace_36 Myrhdh_36
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | sshedmake_namespace_36.myrhdh_36.hello_world }}"
"""
